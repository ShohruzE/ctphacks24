  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen min-w-full">
      <div className="flex flex-col items-center w-full max-w-4xl">
        ...
        <p className="mb-8">Based on your answers, we think these clubs would be a perfect fit for you!</p>
                ...
                <div className="p-4">
                  <Card>
                    <CardContent className="flex aspect-square items-center justify-center p-6">
                      <span className="text-2xl font-semibold">Club Name {index + 1}</span>
                    </CardContent>
                  </Card>
                </div>
              </CarouselItem>
      ...
      <div className="flex flex-col items-center w-full max-w-4xl">
        <h1 className="text-2xl font-bold text-center">Did you find a club you like?<br />Make your own!</h1>
